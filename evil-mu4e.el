...
(defvar evil-mu4e-mode-map-bindings
  `((,evil-mu4e-state mu4e-main-mode-map "J"               mu4e~headers-jump-to-maildir)
    ...
    (,evil-mu4e-state mu4e-headers-mode-map "g["           mu4e-headers-prev-unread)
    (,evil-mu4e-state mu4e-headers-mode-map "g]"           mu4e-headers-next-unread)
    (,evil-mu4e-state mu4e-headers-mode-map "g+"           mu4e-headers-mark-for-flag)
    (,evil-mu4e-state mu4e-headers-mode-map "g-"           mu4e-headers-mark-for-unflag)
